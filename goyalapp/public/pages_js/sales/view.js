...
$(document).on('click', '.prints', function(e){
   ...
   "<html>"+
   "<head>"+
   "<title>Invoice</title><style type='text/css'>h2,h3,h4,h5,th,td,span,hr,p,b,i{color:#053988!important;}.img-height {height: 160px !important;}hr{margin-top:0px;margin-bottom: 0px;border-top-color: currentcolor;}#hide-table{padding: 14px;}</style>"+
   "</head>"+
   "<body>" + 
   divElements + "</body>";
   window.print();
